...
export interface PhotoResult {
  ...
  subjectYExtent?: { top: number; bottom: number }; // normalized 0-1 span from the topmost to bottommost detected face box; lets a tight crop center on the whole group instead of an average point that can clip whichever face sits furthest from it
