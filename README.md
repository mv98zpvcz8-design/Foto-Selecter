...
- **6 strukturell unterschiedliche Templates** (nicht nur Farbvarianten): Minimalistisch, Raster, Typografie-fokussiert, Editorial, Cinematic/Full-Bleed, Filmstreifen. Raster und Filmstreifen erscheinen nur, wenn genug Fotos für ein sinnvolles Layout vorhanden sind (`minPhotos` je Template).
- **Farbpalette** wird aus dem Durchschnittsfarbwert der ausgewählten Fotos abgeleitet (`colorStats`, bereits Teil der Analyse), mit automatischer Hell/Dunkel-Textfarbwahl für Lesbarkeit.
